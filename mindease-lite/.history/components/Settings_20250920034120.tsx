  ...
  return (
    <View style={[styles.safeArea, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <TouchableOpacity style={[styles.listItem, { backgroundColor: colors.cardBackground, borderBottomColor: colors.border }]} onPress={() => onNavigate('appearance')}>
        ...
        <TouchableOpacity style={[styles.listItem, { backgroundColor: colors.cardBackground, borderBottomColor: colors.border }]} onPress={() => onNavigate('language')}>
          <View style={styles.listItemLeft}>
      ...
      <View style={styles.section}>
        ...
        <View style={[styles.toggleItem, { backgroundColor: colors.cardBackground, borderBottomColor: colors.border }]}>
      ...
      <View style={styles.section}>
        ...
        <View style={[styles.resetItem, { backgroundColor: colors.cardBackground, borderBottomColor: colors.border }]}>
      ...
      <View style={styles.section}>
        ...
        <TouchableOpacity style={[styles.listItem, { backgroundColor: colors.cardBackground, borderBottomColor: colors.border }]} onPress={() => onNavigate('notifications')}>
          <View style={styles.listItemLeft}>
      ...
      <View style={styles.section}>
        ...
        <TouchableOpacity style={[styles.listItem, { backgroundColor: colors.cardBackground, borderBottomColor: colors.border }]} onPress={() => onNavigate('help')}>
          <View style={styles.listItemLeft}>
        ...
        <TouchableOpacity style={[styles.listItem, { backgroundColor: colors.cardBackground, borderBottomColor: colors.border }]} onPress={() => onNavigate('terms')}>
          <View style={styles.listItemLeft}>
