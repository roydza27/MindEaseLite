...
import { Animated, Dimensions, Modal, StyleSheet, Text, TouchableOpacity, View, PanResponder } from 'react-native';
...
export default function BlockKit({ onNavigate }: BlockKitProps) {
  ...
  }, [isTimerActive, pulseAnim, rotateAnim, glowAnim, waveAnim]);
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.presetsContainer}>
        {presetLabels.map((label, index) => (
          ...
          >
            <Ionicons 
              name={selectedDuration === presets[index] ? "checkmark-circle" : "time"} 
              size={16} 
