  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <TouchableOpacity style={[styles.reportBanner, { backgroundColor: '#FFB6C1' }]}>
          <Ionicons name="notifications" size={20} color="#FF69B4" />
          <View style={styles.reportContent}>
            <Text style={[styles.reportTitle, { color: '#8B008B' }]}>{t('dashboard.newReport')}</Text>
            <Text style={[styles.reportSubtitle, { color: '#8B008B' }]}>{t('dashboard.reportSubtitle')}</Text>
          </View>
