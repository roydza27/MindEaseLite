...
export default function Activity({ onNavigate }: ActivityProps) {
  console.log('Activity component rendering - THIS SHOULD APPEAR IN CONSOLE');
  return (
    <View style={{ 
      flex: 1, 
      backgroundColor: 'red', 
      ...
      <Text style={{ fontSize: 14, color: 'yellow', marginTop: 10 }}>If you see this, Activity is working!</Text>
    </View>
  );
}
