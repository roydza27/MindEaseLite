  ...
  return (
    <View style={styles.safeArea}>
      ...
      <View style={styles.section}>
        ...
        <TouchableOpacity style={styles.listItem} onPress={() => setShowAppearanceSettings(true)}>
          <View style={styles.listItemLeft}>
            <Text style={styles.listItemText}>Appearance</Text>
          </View>
          <View style={styles.listItemRight}>
            <Text style={styles.settingValue}>{currentTheme.charAt(0).toUpperCase() + currentTheme.slice(1)}</Text>
