...
export default function MoodTracker({ onNavigate }: MoodTrackerProps) {
  ...
  // Initialize rotation to current mood position
  React.useEffect(() => {
    const initialRotation = (moodRating - 1) * 72; // Start at current mood position
    setCurrentRotation(initialRotation);
    rotationAnim.setValue(initialRotation);
  }, [moodRating, rotationAnim]);
  ...
  const renderRotatingSelector = () => {
    ...
    const panResponder = PanResponder.create({
      ...
      onPanResponderGrant: (evt, gestureState) => {
        // Start of drag - store initial rotation
      },
      onPanResponderMove: (evt, gestureState) => {
        const { dx } = gestureState;
        const rotationSensitivity = 2; // Increased sensitivity for better response
        ...
        console.log('Rotation:', newRotation, 'Normalized:', normalizedRotation, 'Mood Index:', moodIndex);
        ...
        <View style={styles.selectorContainer} {...panResponder.panHandlers}>
          ...
          >
            {questions[0].options.map((option, index) => {
              ...
              const radius = 100; // Reduced radius for better positioning
              ...
              return (
                <View
                  ...
                  style={[
                    ...
                    {
                      left: 150 + x - 25, // Center of 300px container
                      top: 100 + y - 25,  // Adjusted for semi-circle positioning
