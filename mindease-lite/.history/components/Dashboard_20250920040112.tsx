      ...
      <View style={styles.content}>
        ...
        <TouchableOpacity style={[styles.reportBanner, { backgroundColor: colors.accent }]}>
          ...
          <View style={styles.reportContent}>
            <Text style={[styles.reportTitle, { color: colors.text }]}>New Report Available</Text>
            <Text style={[styles.reportSubtitle, { color: colors.textSecondary }]}>Your weekly summary is ready.</Text>
          </View>
