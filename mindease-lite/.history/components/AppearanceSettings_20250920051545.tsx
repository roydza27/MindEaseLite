...
export default function AppearanceSettings({ onNavigate, currentTheme, onThemeChange }: AppearanceSettingsProps) {
  ...
  const { t } = useLanguage();
  const themes = [
    { id: 'light', label: t('appearance.light'), description: t('appearance.lightDesc'), icon: 'sunny' },
    { id: 'dark', label: t('appearance.dark'), description: t('appearance.darkDesc'), icon: 'moon' },
    { id: 'system', label: t('appearance.system'), description: t('appearance.systemDesc'), icon: 'phone-portrait' },
  ];
    ...
    <View style={[styles.safeArea, { backgroundColor: colors.surface }]}>
      ...
      >
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: colors.textSecondary }]}>{t('appearance.sectionTitle')}</Text>
