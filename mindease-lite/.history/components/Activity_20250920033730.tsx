  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={[styles.header, { backgroundColor: colors.background }]}>
        <Text style={[styles.headerTitle, { color: colors.text }]}>Activity Achievements</Text>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.metricsGrid}>
          <View style={[styles.metricCard, { backgroundColor: colors.cardBackground }]}>
            ...
            <Text style={[styles.metricLabel, { color: colors.textSecondary }]}>Days of Activity</Text>
          </View>

          <View style={[styles.metricCard, { backgroundColor: colors.cardBackground }]}>
            <Text style={[styles.metricValue, { color: '#4A90E2' }]}>240</Text>
            <Text style={[styles.metricLabel, { color: colors.textSecondary }]}>Total Minutes</Text>
          </View>

          <View style={[styles.metricCard, { backgroundColor: colors.cardBackground }]}>
            <Text style={[styles.metricValue, { color: '#FF8C42' }]}>20</Text>
            <Text style={[styles.metricLabel, { color: colors.textSecondary }]}>Average Minutes</Text>
          </View>
        </View>

        <View style={styles.progressContainer}>
          <Text style={[styles.progressLabel, { color: colors.textSecondary }]}>Monthly Goal Progress</Text>
