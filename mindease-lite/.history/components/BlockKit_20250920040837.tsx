...
export default function BlockKit({ onNavigate }: BlockKitProps) {
  ...
  }, [isTimerActive, pulseAnim, rotateAnim]);
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={[styles.header, { backgroundColor: colors.background }]}>
        <Text style={[styles.title, { color: colors.text }]}>blocliit</Text>
      ...
      <View style={styles.mainTimerContainer}>
        <Text style={[styles.mainTimer, { color: colors.text }]}>00 : 00</Text>
        <View style={styles.timerAdjuster}>
          <Text style={[styles.adjusterLabel, { color: colors.text }]}>01</Text>
        </View>
        <View style={styles.modeIndicator}>
          ...
          <Text style={[styles.modeText, { color: colors.textSecondary }]}>Normal</Text>
      ...
      <View style={styles.sliderContainer}>
        ...
        <View style={styles.sliderLabels}>
          <View style={styles.sliderLabel}>
            ...
            <Text style={[styles.sliderLabelText, { color: colors.textSecondary }]}>Hour</Text>
          </View>
          <View style={styles.sliderLabel}>
            <View style={styles.sliderIcon} />
            <Text style={[styles.sliderLabelText, { color: colors.textSecondary }]}>3 hr</Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.actionButtons}>
        ...
        <TouchableOpacity style={styles.saveButton}>
          <Text style={[styles.saveButtonText, { color: colors.primary }]}>Save Preset</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
