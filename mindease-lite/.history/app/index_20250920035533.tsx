      ...
      <View style={styles.content}>
        {currentScreen === 'appearance' ? (
          ...
          <>
            ...
            {activeTab === 'settings' && <Settings onNavigate={handleNavigate} currentTheme={theme} onThemeChange={(theme: string) => setTheme(theme as 'light' | 'dark' | 'system')} currentLanguage={currentLanguage} onLanguageChange={setCurrentLanguage} />}
          </>
        )}
      </View>
